...
- Create a second network test pod with `kubectl run net-test-1 --image=subfuzion/netcat --command -- /bin/sh -c 'while true; do echo -n read_input | nc -vz 1.1.1.1 53; sleep 2; done'`
