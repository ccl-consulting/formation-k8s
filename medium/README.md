...
- Run a simple network test pod with `kubectl run net-test --image=chainguard/netcat --command -- /bin/sh -c 'while true; do echo -n read_input | timeout 1 nc -vz 1.1.1.1 53; sleep 2; done'`
